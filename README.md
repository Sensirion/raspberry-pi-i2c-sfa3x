...
This document explains how to set up the Sfa3x sensor to run on a Raspberry Pi
using the provided code.

TODO: DRIVER_GENERATOR Add picture of sensor to images/Sfa3x.png
[<center><img src="images/Sfa3x.png" width="300px"></center>](TODO: DRIVER_GENERATOR Add evaluation kit URL)
...
the following pins to connect your Sfa3x:
...
- Download the driver for the [Sensirion Github Page](https://github.com/Sensirion/raspberry-pi-i2c-sfa3x) and extract the `.zip` on your Raspberry Pi
- Compile the driver
